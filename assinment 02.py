...
print("question4")
num_1=int(input("Give first number:")) #Input first number
num_2=int(input("Give second number:")) #Input second number
num_3=int(input("Give third number:")) #Input third number
